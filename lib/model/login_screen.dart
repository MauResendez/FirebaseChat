...
class _LoginSignUpPageState extends State<LoginScreen> 
{
  ...
  void _validateAndSubmit() async 
  {
    ...
    {
      String userId = "";
      final DatabaseReference _userDB = FirebaseDatabase.instance.reference().child("User");
      ...
      try 
      {
        ...
        else 
        {
          userId = await widget.auth.signUp(_email, _password);
           _userDB.child(userId).child("Email").set(_email);
           _userDB.child(userId).child("Password").set(_password);
